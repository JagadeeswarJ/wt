...
<project xmlns="http://maven.apache.org/POM/4.0.0" 
  ...
  <groupId>BookStoreAppAuth</groupId>
  <artifactId>BookStoreAppAuth</artifactId>
  <version>0.0.1-SNAPSHOT</version>
  <packaging>war</packaging>

  <dependencies>

    <!-- Servlet API — provided means Tomcat supplies it at runtime, NOT bundled in WAR -->
    <dependency>
    ...
    <!-- MySQL Driver — no scope, so it IS bundled in WEB-INF/lib -->
    <dependency>
